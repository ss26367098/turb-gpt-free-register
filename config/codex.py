...
#                （与 GrizzlySMS 同为 handler_api 协议；OpenAI 服务代码是 dr，不是 openai）
...
# SMSBower 接码 API 基址（SMS_PROVIDER="smsbower" 时使用）
...
# Key 与 GrizzlySMS 的分开填写；smsbower 通道优先用它，留空时才回退 SMS_API_KEY。
